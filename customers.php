            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="groups.php">
                                <i class="fas fa-users"></i>Customize Your Own Group</a>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                       ...
                       <h3 class="alert alert-info">Groups Found in: 
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                             ...
                                             <?php
                                                    ...
                                                    $sql = "SELECT * FROM customers_group WHERE group_country='$choose_group'";
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        echo '<h1 class="alert alert-danger">0 results</h1>';
                                                    }
                                                    $conn->close();
                                                    ?>
                       ...
                       <!-- Modal -->
                       <hr>
                     <div class="modal fade bd-example-modal-lg" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="false">
                                    ...
                                    <table class="table table-borderless table-data3">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Starting Period Query</th>
                                                <th>Ending Period Query</th>
                                                <th>Task</th>
                                        ...
                                        <tbody>
                                            <?php
                                                    ...
                                                    $sql = "SELECT * FROM customers WHERE country='$choose'";
                                                    $result = $conn->query($sql);
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while($row = $result->fetch_assoc()) {
                                                            ...
                                                            echo '<input type="date" class="form-control" name="date1" required/>';
                                                            echo "</td>";
                                                            echo "<td>";
                                                            echo '<input type="date" class="form-control" name="date2" required/>';
                                                            echo "</td>";
                                                            echo "<td>";
                                                            

                                                            echo '<button type="submit" class="btn btn-success">View Data</button>';
