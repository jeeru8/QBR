            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="generate4.php">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h5> <b>Customer Name:</b> &nbsp;ANSON BAY MEDICAL CENTRE</h5>
                                    <br>
                                    <h5> Country of Operation: &nbsp;Malaysia</h5>
                                    <br>
                            ...
                            <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td>GIB_S_MY_1553XR0049</td>  
                                               <td>9800 C-ARM VASCULAR 9" SUPER</td>               
                                               <td>SURGERY</td>
                                               <td>NO CONTRACT</td>
                                                <td>11/19/2016</td>
                                                <td></td>
                        ...
                        <hr>
                          ...
                          <div class="row" align="center">
                            <div class="col-md-12">
                                ...
                                <img align="center" src="images/MA.png" class="img-responsive"/>
