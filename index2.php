            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="generate2.php">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h5> <b>Customer Name:</b> &nbsp;Alexandra Hospital</h5>
                                    <br>
                                    <h5> Country of Operation: &nbsp;Singapore</h5>
                                    <br>
                            ...
                            <div class="col-md-6">
                                <img width="500" height="500" src="images/wallpaper2.jpg" class="img-responsive" align="center"/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            <tr>
                                               <td>GIB_S_SG_0847030040</td>  
                                               <td>SVC- SENOESSENTIAL W/ STEREO</td>               
                                               <td>MAMMOGRAPHY</td>
                                               <td>CONTRACT</td>
                                                <td>12/27/2013</td>
                                                <td>4/1/2019</td>
                                            ...
                                            <tr>
                                               <td>GIB_S_SG_0847360050</td>  
                                               <td>LOGIC 400 115V NTSC</td>               
                                               <td>ULTRASOUND</td>
                                               <td>NO CONTRACT</td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr>
                                               <td>GIB_S_SG_0847374819</td>  
                                               <td>LOGIQ P5 PREMIUM</td>               
                                               <td>ULTRASOUND</td>
                                               <td> CONTRACT</td>
                                                <td></td>
                                                <td></td>
                                              ...
                                              <tr>
                                               <td>GIB_S_SG_0847384062AW1</td>  
                                               <td>ECHOPAC PC WORKSTATION</td>               
                                               <td>ULTRASOUND</td>
                                               <td>NO CONTRACT</td>
                                                <td></td>
                                                <td></td>
                                              ...
                                              <tr>
                                               <td>GIB_S_SG_0847550022</td>  
                                               <td>C-PACS 3.0 EE SW</td>               
                                               <td>RAD SYSTEMS</td>
                                               <td>NO CONTRACT</td>
                                                <td></td>
                                                <td></td>
                                              ...
                                              <tr>
                                               <td>GIB_S_SG_09DG2EUA</td>  
                                               <td>VIEWPOINT OPTIONS HARDWARE</td>               
                                               <td>ULTRASOUND</td>
                                               <td>NO CONTRACT</td>
                                                <td></td>
                                                <td></td>
                        ...
                        <hr>
                          ...
                          <div class="row" align="center">
                            <div class="col-md-12">
                                ...
                                <img align="center" src="images/SG.png" class="img-responsive"/>
