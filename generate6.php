            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="generate6.php">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <h1 align="center" class="alert alert-info">Generate QBR Report</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 align="center" class="alert alert-info">Put Commentary Before Export</h3>

                                <form action="VI.pdf" method="POST">
                            ...
                            <div class="col-md-6">
                                <img src="images/wallpaper.jpg" class="img-responsive"/>
                            </div>
                        </div>
