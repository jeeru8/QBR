            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="generate5.php">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h5> <b>Customer Name:</b> &nbsp;DARMO HOSPITAL</h5>
                                    <br>
                                    <h5> Country of Operation: &nbsp;Indonesia</h5>
                                    <br>
                            ...
                            <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            <tr>
                                               <td>1-5990868531</td>  
                                               <td>MX135 CT Venus ESR - RoHS compliant Green</td>               
                                               <td>OTHER</td>
                                               <td>NO CONTRACT</td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr>
                                               <td>GIB_S_ID_5512CT0069</td>  
                                               <td>REVOLUTION ACTS SVCT INDIA</td>               
                                               <td>CT</td>
                                               <td>NO CONTRACT</td>
                                                <td>3/9/2018</td>
                                                <td>3/10/2018</td>
                        ...
                        <hr>
                          ...
                          <div class="row" align="center">
                            <div class="col-md-12">
                                ...
                                <img align="center" src="images/IN.png" class="img-responsive"/>
